    ...
    public partial class InitialCreation : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    FK_UserRole_UserId_UserId = table.Column<int>(name: "FK_UserRole_UserId_User Id", type: "int", nullable: false),
                    RoleId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserRole", x => new { x.FK_UserRole_UserId_UserId, x.RoleId });
                    table.ForeignKey(
                        name: "FK_UserRole_User_FK_UserRole_UserId_User Id",
                        column: x => x.FK_UserRole_UserId_UserId,
                        principalTable: "User",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
